...
case object StrawberryBasilIceCream extends Recipe with IceCream {
  ...
  override val notes: Option[String] = Some(
    s"""$genericNotes
        ...
        |
        |Kit tasting notes: smells like pesto, tastes juicy and fruity with strawberry dominating the basil. Pepper a bit weak. Might improve after a few days in the freezer but I should consider soaking the pepper in the mascarpone for a day in the fridge before making ice cream.""".stripMargin
  )
