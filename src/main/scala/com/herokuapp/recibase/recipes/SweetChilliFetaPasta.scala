...
object SweetChilliFetaPasta extends
Recipe(
...
There are basically no quantities. Add what seems right."""
  ...
  List(
    ...
    Ingredient("Feta", Some("1 block, approx. 200g"), Some("cut into 1cm cubes")),
    Ingredient("Tuna chunks", Some("1 80g tin"), Some("drained"), Some("Optional")),
    Ingredient("Sweet chilli sauce"),
    Ingredient("Black pepper"),
    Ingredient("Fusilli", None, None, Some("Spaghetti also works well here"))
  ),
  List(
