...
object SmokyFishSweetPotatoCurry extends
Recipe(
  ...
  List(
    ...
    Ingredient("Creamed coconut", Some("50g"), None, Some("More is better")),
    Ingredient(
      "Ginger",
      Some("30g"),
    ...
    Ingredient("Sweet potato", Some("200g"), Some("cut into bite-size pieces")),
