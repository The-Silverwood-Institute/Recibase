...
For frying the paneer, the goal is something like a very shallow shallow fry, with more oil than would be used for pan frying but less than most shallow frying. A sautee pan is ideal for this."""
  ...
  List(
    ...
    Ingredient("Ground cumin", Some("1/2 tsp"), None, Some("Probably optional")),
    Ingredient(
      "Ground cinnamon",
      Some("1/2 tsp"),
      None,
    ...
    Ingredient(
      ...
      Some("2"),
      Some("diced"),
      Some("Tins of chopped tomatoes are far too wet for this. Also optional.")
    ),
    Ingredient(
      "Spinach",
