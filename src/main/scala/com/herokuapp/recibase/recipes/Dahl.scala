...
Recipe(
  ...
  List(
    ...
    Ingredient("Water", Some("800ml"), Some("boiling"), Some("Quantity is important!")),
    Ingredient("Ground turmeric", Some("1 tsp"), None, Some("Use 2-3 tsp instead")),
    ...
    Ingredient("Garam masala", Some("1/2 tsp"), None, Some("Use at least 1 tsp")),
    Ingredient("Salt"),
