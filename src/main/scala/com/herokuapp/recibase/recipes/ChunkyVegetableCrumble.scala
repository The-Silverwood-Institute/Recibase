...
object ChunkyVegetableCrumble extends
Recipe(
...
List(
  ...
  Ingredient("Garlic", Some("3 minimum"), Some("finely chopped or crushed")),
  Ingredient("Carrots", Some("3"), Some("cut into 2cm chunks")),
  Ingredient("Parsnips", Some("2"), Some("cut into 2cm chunks")),
  Ingredient("Baby turnips", Some("350g"), Some("quartered"), Some("Optional. Never been added")),
  Ingredient(
    "New potatoes",
    Some("5-6"),
  ...
  Ingredient("Bay leaves", Some("2"), None, Some("Optional. Never been added")),
  Ingredient("Butter beans", Some("1 410g tin"), Some("drained and rinsed")),
  Ingredient("Thyme", Some("1-2 tsp"), None, Some("Optional")),
  Ingredient("Salt"),
  Ingredient("Pepper"),
  Ingredient("Flour", Some("85g")),
  Ingredient("Butter", Some("30g"), Some("diced"), Some("Should be cool, not room temp.")),
  Ingredient(
