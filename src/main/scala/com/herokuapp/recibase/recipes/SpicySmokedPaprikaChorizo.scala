...
object SpicySmokedPaprikaChorizo extends
Recipe(
...
You could try serving this dish over grilled aubergines."""
  ...
  List(
    Ingredient("Spanish Chorizo", Some("225g"), None, Some("ideally good quality")),
    Ingredient("Red Onions", Some("4"), Some("finely diced")),
    Ingredient("Garlic Cloves", Some("Several"), Some("fined diced or crushed in a press")),
    Ingredient("Pointed Red Pepper", Some("1"), Some("sliced")),
    Ingredient("Carrots", Some("2-3"), Some("diced")),
    Ingredient("Fresh Spinach", Some("100g"), Some("torn"), Some("frozen would also work")),
    Ingredient("Tinned Tomatoes", Some("3")),
    Ingredient("Tomato Paste", Some("4 Inches")),
    Ingredient("Red Wine", Some("10-20CL"), None, Some("something in the \u00a35-10 range")),
    Ingredient("Smoked Paprika", Some("Several teaspoons")),
    Ingredient("Olive Oil"),
    Ingredient("Chilli Flakes"),
    Ingredient("Honey", Some("2 tsp"), None, Some("anything but that Rowse shit")),
    Ingredient("Dried Oregano", Some("1 tbsp")),
    Ingredient("Stick of Cinnamon", Some("1"), None, Some("Ground also works")),
