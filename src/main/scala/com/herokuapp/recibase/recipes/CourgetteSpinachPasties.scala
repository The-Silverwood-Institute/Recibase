...
object CourgetteSpinachPasties extends
Recipe(
  ...
  List(
    ...
    "Mix the grated courgette, goats cheese, nutmeg and spinach in a pan on a low heat.",
    ...
    "Bake in the oven at 220C/200C fan/gas 7 for 40 minutes."
  )
)
