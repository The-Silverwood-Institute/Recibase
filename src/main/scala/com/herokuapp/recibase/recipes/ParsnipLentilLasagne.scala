...
object ParsnipLentilLasagne extends
Recipe(
  ...
  List(
    ...
    Ingredient("Milk", Some("100ml"), None, Some("Full fat or semi-skimmed")),
    ...
    Ingredient("Kidney Beans", Some("2 400g tins"), Some("drained and rinsed")),
